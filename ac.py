        ...
        "messages": [
            {
                ...
                "content": (
                    ...
                    "3. 뉴스 본문 안 '주식회사'들의 회사명을 모두 추출하여 'companies' 배열에 기존과 동일한 JSON 형식으로 리포트를 출력해. (주식회사 외에 기업은 추출하지 말아줘. 예를 들어 '경기도' 등은 회사, 기업이 아니니까 추출하면 안돼. '애플파크'처럼 장소명이나 조직명은 추출하지마)\n"
